...
const UploadFile = () => {
    ...
    return (
        ...
        <div className="mt-10">
            <div className="flex">
                ...
                <div className="p-3">
                    { !fileUrl && (
                        <>
                            <label>
                                <span className="text-white bg-blue-400 rounded-lg p-4 font-bold cursor-pointer">Add file</span>
            ...
            <div className="mt-3">
                { fileUrl && ( <button className="bg-blue-400 rounded-lg text-white p-4 font-bold" onClick={uploadToContract}>Upload file</button> ) }
            </div>
        </div>        
        </>
    )
